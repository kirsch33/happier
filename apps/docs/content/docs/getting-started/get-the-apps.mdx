...
<Cards>
  <Card title="iPhone and iPad" href="https://apps.apple.com/app/happier-claude-codex-opencode/id6758554297" description="Happier on the App Store." />
...
[app.happier.dev](https://app.happier.dev/) is the
