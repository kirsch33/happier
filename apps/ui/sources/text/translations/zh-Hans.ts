...
export const zhHans: TranslationStructure = {
  ...
  connectedServices: {
    ...
    authSwitch: {
      ...
      switchFailed: "无法为此会话切换认证。",
            errors: {
                groupGenerationConflict: '账号池在切换完成前已更改。刷新账号列表后重试。',
                ...
                groupMissing: '所选账号池不再可用。刷新账号列表并选择其他账号池。',
    ...
    list: {
      ...
      needsReauth: "需要重新认证",
      notConnected: "未连接",
      addServiceTitle: "连接服务",
      addServiceMessage: "选择要连接账号的服务。",
    },
    ...
    account: {
      ...
      memberEnabledLabel: "已在池中启用",
      poolsLabel: "池",
      planEmailSubtitle: ({ plan, email }: { plan: string; email: string }) => `${plan} · ${email}`,
      poolsCount: ({ count }: { count: number }) => `${count} 个池`,
      defaultStarA11y: "默认账户",
      setActiveA11y: "设为活动账户",
      activeMemberA11y: "活动账户",
      resets: {
        use: "使用",
        available: "可用重置",
        rowLabel: ({ date, countdown }: { date: string; countdown: string }) => `${date} 到期 · ${countdown}`,
        now: "现在",
        inDays: ({ days }: { days: number }) => `${days} 天后`,
        confirmTitle: "使用此重置？",
        confirmMessage: "这会应用一次用量重置以立即恢复配额。此操作无法撤销。",
        confirmCta: "使用重置",
      },
    },
    oauthPaste: {
    ...
    diagnostics: {
      title: {
        ...
        runtime_auth_recovery_superseded: "提供商恢复已被取代",
        runtime_auth_generation_stale: "提供商恢复已过期",
        hot_apply_unavailable: "热切换账号不可用",
        app_server_unavailable: "提供商应用服务器不可用",
        provider_account_adoption_mismatch: "提供商未切换账号",
        provider_account_identity_unverified: "提供商账号身份未验证",
        post_switch_verification_failed: "无法验证提供商账号",
        quota_snapshot_stale: "配额数据已过期",
      ...
      status: {
        ...
        runtime_auth_recovery_superseded: "提供商恢复已被取代",
        runtime_auth_generation_stale: "提供商恢复代次已过期",
        hot_apply_unavailable: "热切换账号不可用",
        app_server_unavailable: "提供商应用服务器不可用",
    ...
    detail: {
      ...
      errors: {
        credentialReferencedByGroup: "此账号仍被账号池使用。请先从池中移除，然后重试。",
        credentialNotFound: "此已连接账号已被移除。",
        credentialRequestFailed: "已连接账号请求失败。请刷新已连接服务后重试。",
        groupRequestFailed: "账号池请求失败。请刷新已连接服务后重试。",
        generationConflict: "此账号池在操作完成前已更改。请刷新已连接服务后重试。",
        groupNotFound: "此账号池已不存在。请刷新已连接服务后重试。",
        memberNotFound: "此账号已不再是该池成员。请刷新已连接服务后重试。",
        profileNotFound: "此已连接账号已不存在。请刷新已连接服务后重试。",
        fallbackDisabled: "此服务器已禁用手动池切换。",
      ...
      groupActions: {
        title: "池操作",
        createTitle: "创建池",
        createSubtitle: "为此已连接服务添加回退池。",
        groupIdTitle: "池 ID",
        groupIdBody: "为此已连接服务池选择一个简短 ID。",
        groupIdPlaceholder: "team-pool-cn",
        invalidGroupIdTitle: "池 ID 无效",
        invalidGroupIdBody: "请使用字母、数字、点、连字符或下划线（最多 64 个字符）。",
        displayNameTitle: "池显示名称",
        displayNameBody: "可选。显示在身份选择器和设置中。",
        displayNamePlaceholder: "团队账号池",
        editTitle: "编辑显示名称",
        deleteTitle: "删除池",
        deleteConfirmTitle: "删除池",
        deleteConfirmBody: ({ group }: { group: string }) => `删除“${group}”？使用此池的会话将需要选择另一个账号。`,
        ...
        addMember: "添加成员",
        addMemberSubtitle: "将现有已连接配置文件添加到此池。",
        noProfilesAvailable: "所有已连接配置文件都已是成员。",
        memberProfileTitle: "成员配置文件",
        memberProfileBody: "输入要添加到此池的配置文件 ID。",
        makeActive: "设为当前",
        activeMember: "当前成员",
        enableMember: "启用成员",
        disableMember: "禁用成员",
        ...
        removeMemberConfirmBody: ({ profileId }: { profileId: string }) => `从此池移除“${profileId}”？`,
        ...
        membersTitle: "成员",
        membersSubtitle: "勾选要包含在此池中的配置文件。",
      },
      groupDetail: {
        routeTitle: "池",
        nameTitle: "池名称",
        ...
        recoveryModeOffSubtitle: "不自动恢复此池。",
        ...
        recoveryPromptSubtitle: "对此池使用标准恢复和继续提示。",
        missingTitle: "未找到池",
        missingBody: ({ service, groupId }: { service: string; groupId: string }) =>
          `${service} 中不存在名为“${groupId}”的池。`,
      },
    },
    pools: {
      title: "池",
      ...
      manualBadge: "手动",
      capacity: ({ percent }: { percent: number }) => `容量 ${percent}%`,
      avatarOverflowA11y: ({ count }: { count: number }) => `另有 ${count} 名成员`,
      memberWarningsA11y: ({ count }: { count: number }) => `${count} 名成员需要注意`,
      create: {
        title: "创建池",
        subtitle: "为此已连接服务添加回退池。",
      },
      empty: {
        title: "暂无池",
      ...
      behavior: {
        ...
        autoRestorePrimarySubtitle: "当首选成员的配额重置后切换回它。",
        switchOnGroupSubtitle: "发生此情况时切换到其他成员。",
        switchOn: {
          usageLimit: "已达用量上限",
          authExpired: "身份验证已过期",
      ...
      delete: {
        title: "删除池",
        subtitle: "删除此池。成员账号仍保持连接。",
        confirmTitle: "删除池",
        confirmMessage: ({ name }: { name: string }) => `删除“${name}”？使用此池的会话将需要选择另一个账号。`,
      },
    },
    profile: {
      profileId: "配置 ID",
    ...
    authModal: {
      ...
      groupNeedsMembersSubtitle: "使用此池前请添加或启用成员",
      groupSwitchingSubtitle: "正在切换池成员",
      groupErrorSubtitle: "此池需要处理",
  ...
  session: {
    ...
    usageLimitRecovery: {
      ...
      forgetAction: "每次询问",
      hideBannerAction: "隐藏使用限制横幅",
      showBannerAction: "显示使用限制横幅",
    ...
    forking: {
      ...
      strategy: {
	    ...
	    staleRunner: {
	      ...
	      statusBadge: "旧版 CLI",
	      showBannerAction: "显示旧版 CLI 通知",
	      hideBannerAction: "隐藏旧版 CLI 通知",
	      errorTitle: "运行器重启不可用",
    ...
    machineOfflineCannotResume: "机器离线。请将其恢复在线后再恢复此会话。",
      ...
      openTranscriptNavigation: "打开转录导航",
      participants: {
        to: '发送给',
        lead: '主助手',
        sendToTitle: '发送给',
    ...
    reviewFindings: {
      ...
      pendingMessages: {
        ...
        deliveryBlockedReasons: {
          ...
          runtimeDisposedBeforeDelivery: "运行时在投递前已关闭",
          invalidPromptText: "消息文本无法投递",
  ...
  executionRuns: {
    ...
    details: {
      ...
      settingsActions: {
        ...
        approvalHelpBody: "“先询问”会在此操作从该界面运行前创建批准请求。对于 AI 会话，该请求会排入现有批准界面，而不会在模态窗口中等待。“允许”则让此操作从该界面运行，而无需批准请求。",
        toolExposure: {
            title: "工具公开",
...
settingsSession: {
    newSessionDraftEntry: {
        ...
        rootGroups: {
            ...
            mobileLayout: {
                title: '移动端会话布局',
                footer: '选择会话内使用的手机布局。在驾驶舱模式下，在底部栏左右滑动会按你最后看到的列表顺序切换到下一个或上一个会话。',
            },
    ...
    messageSending: {
      ...
      pendingDeliveryTimingFooter:
        "选择待发送消息是在主回复就绪后发送，还是等所有已跟踪运行时活动空闲后再发送。",
      pendingDeliveryTiming: {
        afterForegroundReadyTitle: "主回复之后",
        afterForegroundReadySubtitle:
          "代理可以接受下一轮时立即发送待发送消息。",
        afterRuntimeIdleTitle: "运行时空闲后",
        afterRuntimeIdleSubtitle:
          "当已跟踪运行时活动仍在进行时，继续保留待发送消息。",
      },
