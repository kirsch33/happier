...
const zhHantOverrides: DeepPartial<TranslationStructure> = {
  settingsKeyboard: {
    ...
    connectedServices: {
        ...
        authSwitch: {
            ...
            errors: {
                groupGenerationConflict: '帳號池在切換完成前已變更。請重新整理帳號清單後再試一次。',
                ...
                groupMissing: '選取的帳號池已無法使用。請重新整理帳號清單並選擇其他池。',
        ...
        defaultAuth: {
            ...
            warning: {
                ...
                connected_group_unavailable: '預設已連線池無法使用；將使用原生認證。',
                connected_group_disabled: '此處已停用已連線池；將使用原生認證。',
        ...
        quota: {
            ...
            recoveryCreditSubtitle: '立即套用用量重置以恢復配額。',
        ...
        account: {
            ...
            memberEnabledLabel: '已在池中啟用',
            poolsLabel: '池',
            planEmailSubtitle: ({ plan, email }: { plan: string; email: string }) => `${plan} · ${email}`,
            poolsCount: ({ count }: { count: number }) => `${count} 個池`,
            defaultStarA11y: '預設帳戶',
            setActiveA11y: '設為使用中帳戶',
            activeMemberA11y: '使用中帳戶',
            resets: {
                use: '使用',
                available: '可用重設',
                rowLabel: ({ date, countdown }: { date: string; countdown: string }) => `${date} 到期 · ${countdown}`,
                now: '現在',
                inDays: ({ days }: { days: number }) => `${days} 天後`,
                confirmTitle: '使用此重設？',
                confirmMessage: '這會套用一次用量重設以立即恢復配額。此操作無法復原。',
                confirmCta: '使用重設',
            },
        },
        oauthPaste: {
        ...
        diagnostics: {
            title: {
                ...
                runtime_auth_recovery_superseded: '供應商復原已被取代',
                runtime_auth_generation_stale: '供應商復原已過期',
                hot_apply_unavailable: '即時帳號切換不可用',
                app_server_unavailable: '供應商應用程式伺服器不可用',
                provider_account_adoption_mismatch: '提供者未切換帳號',
                provider_account_identity_unverified: '供應商帳號身分未驗證',
                post_switch_verification_failed: '無法驗證提供者帳號',
                quota_snapshot_stale: '配額資料已過期',
                quota_fetch_disabled: '配額檢查已停用',
                quota_fetch_backoff: '配額檢查已退避',
                auth_surface_weakly_verified: '驗證重寫已驗證',
                connected_service_restart_requested: '已要求重新啟動工作階段',
            ...
            status: {
                ...
                runtime_auth_recovery_superseded: '供應商復原已被取代',
                runtime_auth_generation_stale: '供應商復原世代已過期',
                hot_apply_unavailable: '即時帳號切換不可用',
                app_server_unavailable: '供應商應用程式伺服器不可用',
                ...
                quota_snapshot_stale: '配額資料已過期',
                quota_fetch_disabled: '配額檢查已停用',
                quota_fetch_backoff: '配額檢查暫時退避',
                auth_surface_weakly_verified: '驗證重寫僅弱驗證',
                connected_service_restart_requested: '已要求重新啟動工作階段',
                connected_service_credential_reconnect_required: '已連線的帳戶需要重新連線',
        ...
        detail: {
            ...
            errors: {
                credentialReferencedByGroup: '此帳號仍被帳號池使用。請先從池中移除，然後重試。',
                credentialNotFound: '此已連線帳號已被移除。',
                credentialRequestFailed: '已連線帳號請求失敗。請重新整理已連線服務後重試。',
                groupRequestFailed: '帳號池請求失敗。請重新整理已連線服務後重試。',
                generationConflict: '此帳號池在操作完成前已變更。請重新整理已連線服務後重試。',
                groupNotFound: '此帳號池已不存在。請重新整理已連線服務後重試。',
                memberNotFound: '此帳號已不再是該池成員。請重新整理已連線服務後重試。',
                profileNotFound: '此已連線帳號已不存在。請重新整理已連線服務後重試。',
                fallbackDisabled: '此伺服器已停用手動池切換。',
            ...
            groupActions: {
                title: '池操作',
                createTitle: '建立池',
                createSubtitle: '為此已連線服務新增備援池。',
                groupIdTitle: '池 ID',
                groupIdBody: '為此已連線服務池選擇一個簡短 ID。',
                groupIdPlaceholder: 'team-pool-tw',
                invalidGroupIdTitle: '池 ID 無效',
                invalidGroupIdBody: '請使用字母、數字、點、連字號或底線（最多 64 個字元）。',
                displayNameTitle: '池顯示名稱',
                displayNameBody: '選填。會顯示在驗證選擇器與設定中。',
                displayNamePlaceholder: '團隊帳號池',
                editTitle: '編輯顯示名稱',
                deleteTitle: '刪除池',
                deleteConfirmTitle: '刪除池',
                deleteConfirmBody: ({ group }: { group: string }) => `刪除「${group}」？使用此池的工作階段將需要選擇另一個帳號。`,
                ...
                addMember: '新增成員',
                addMemberSubtitle: '將現有已連線設定檔新增到此池。',
                noProfilesAvailable: '所有已連線設定檔都已是成員。',
                memberProfileTitle: '成員設定檔',
                memberProfileBody: '輸入要新增到此池的設定檔 ID。',
                makeActive: '設為目前',
                activeMember: '目前成員',
                enableMember: '啟用成員',
                disableMember: '停用成員',
                ...
                removeMemberConfirmBody: ({ profileId }: { profileId: string }) => `從此池移除「${profileId}」？`,
            ...
            groupDetail: {
                ...
                recoveryModeOffSubtitle: '不自動恢復此池。',
                ...
                recoveryPromptSubtitle: '對此池使用標準恢復和繼續提示。',
                missingTitle: '找不到池',
                missingBody: ({ service, groupId }: { service: string; groupId: string }) =>
                    `${service} 中不存在名為「${groupId}」的池。`,
            },
        },
        pools: {
            title: '池',
            ...
            manualBadge: '手動',
            capacity: ({ percent }: { percent: number }) => `容量 ${percent}%`,
            avatarOverflowA11y: ({ count }: { count: number }) => `另有 ${count} 位成員`,
            memberWarningsA11y: ({ count }: { count: number }) => `${count} 位成員需要注意`,
            create: {
                title: '建立池',
                subtitle: '為此已連線服務新增備援池。',
            },
            empty: {
                title: '尚無池',
                subtitle: '建立池即可在帳號之間自動備援。',
            },
            loadError: {
                title: '無法載入池',
            ...
            detail: {
                ...
                summary: ({ count, strategy }: { count: number; strategy: string }) => `${count} 個帳號 · ${strategy}`,
                membersTitle: '成員',
                moveUp: '上移',
                moveDown: '下移',
                activeBadge: '目前',
                noMembersTitle: '尚無成員',
                noMembersSubtitle: '將已連線帳號新增到此池。',
                behaviorTitle: '行為',
                advancedTitle: '進階',
                advancedSubtitle: '微調此池切換帳號的時機與方式。',
            ...
            behavior: {
                autoRestorePrimaryTitle: '重設時恢復主要帳號',
                autoRestorePrimarySubtitle: '當首選成員的配額重設後切換回它。',
                switchOnGroupSubtitle: '發生此情況時切換到其他成員。',
                switchOn: {
                    usageLimit: '已達使用量上限',
                    authExpired: '驗證已過期',
                    accountChanged: '帳號已變更',
                    refreshFailure: '重新整理失敗',
                },
            },
            delete: {
                title: '刪除池',
                subtitle: '刪除此池。成員帳號仍保持連線。',
                confirmTitle: '刪除池',
                confirmMessage: ({ name }: { name: string }) => `刪除「${name}」？使用此池的工作階段將需要選擇另一個帳號。`,
            },
        },
        profile: {
            profileId: '設定檔 ID',
        ...
        authModal: {
            ...
            groupNeedsMembersSubtitle: '使用此池前請新增或啟用成員',
            groupSwitchingSubtitle: '正在切換池成員',
            groupErrorSubtitle: '此池需要處理',
  ...
  newSession: {
    ...
    sessionHandoff: sessionHandoffTranslationExtensions['zh-Hant'],
      ...
      session: {
          ...
          usageLimitRecovery: {
            ...
            resetCreditBody: ({ count }: { count: number }) => `${count} 次使用重設可用。`,
            resetCreditExpiresBody: ({ count, time }: { count: number; time: string }) => `${count} 次使用重設可用；下一個將於 ${time} 到期。`,
            readyBody: '你現在可以恢復此工作階段。',
            enableAction: '限制重置後恢復',
            cancelAction: '停止等待',
            checkNowAction: '立即檢查限制',
            consumeResetCreditAction: '套用重設',
            ...
            forgetAction: '每次詢問',
            hideBannerAction: '隱藏使用限制橫幅',
            showBannerAction: '顯示使用限制橫幅',
            statusLimitReached: '已達到限制',
            statusTemporaryThrottle: '暫時受限',
            statusReady: '可恢復',
            statusWaiting: '等待限制重設',
            statusWaitingUntil: ({ time }: { time: string }) => `等待到 ${time}`,
            statusWaitingResetUntil: ({ time }: { time: string }) => `等待配額重設（重設時間 ${time}）`,
            statusAccountRotationPending: '帳號輪換待處理',
        ...
        composerBanners: {
            ...
            staleRunner: {
                ...
                statusBadge: '舊版 CLI',
                showBannerAction: '顯示舊版 CLI 通知',
                hideBannerAction: '隱藏舊版 CLI 通知',
                errorTitle: 'Runner 重新啟動不可用',
                errorBody: 'Daemon 無法重新啟動此工作階段 runner。此工作階段仍可使用。',
            },
            openRuns: '開啟工作階段執行',
            openAutomations: '開啟工作階段自動化',
            openSubagents: ({ count }: { count: number }) => (count > 0 ? `開啟代理 (${count})` : '開啟代理'),
            openTranscriptNavigation: '開啟逐字稿導覽',
            participants: {
                to: '傳送給',
                lead: '主助手',
                sendToTitle: '傳送給',
            ...
            subagents: {
                messages: {
                  ...
                  nativeTypeFact: ({ value }: { value: string }) => `原生類型：${value}`,
                  modelFact: ({ value }: { value: string }) => `模型：${value}`,
                  agentIdFact: ({ value }: { value: string }) => `代理 ID：${value}`,
                  durationFact: ({ value }: { value: string }) => `時長：${value}`,
          ...
          actionsDraft: {
            ...
            pendingMessages: {
                ...
                sendFailedNotice: '訊息未傳送。請檢查你的連線，然後重試。',
                waitingForTurnNotice: ({ minutes }: { minutes: number }) =>
                    minutes > 0
                        ? `等待目前工作完成 · 已執行 ${minutes} 分鐘`
                        : '等待目前工作完成',
                deliveryBlockedReasons: {
                    terminalComposerDraft: '終端機輸入框中的草稿阻擋了遞送',
                    runtimeConfigBlocked: '執行階段設定阻擋了遞送',
                    providerUnavailableBeforeAcceptance: '提供者暫時無法使用',
                    ambiguousTerminalDelivery: '遞送狀態不明確',
                    terminalHostUnreachable: '無法連線到終端機主機',
                    runtimeDisposedBeforeDelivery: '執行階段在遞送前已關閉',
                    invalidPromptText: '訊息文字無法遞送',
                    manualUserHandled: '已標記為已處理',
                    attemptExpiredBeforeWrite: '遞送嘗試在寫入前已過期',
                    providerRejectedBeforeAcceptance: '提供者拒絕了該訊息',
                    payloadTooLarge: '訊息過大',
                    unknown: '需要檢查遞送狀態',
                },
	                empty: '沒有待傳送訊息。',
                ...
                sendAsNewConfirm: {
                    title: '將此訊息以新訊息傳送？',
                    body: '這會封存結果不確定的遞送，並將新副本加入佇列。提供者可能已收到原始訊息，因此訊息可能會被處理兩次。',
                },
                sendConfirm: {
                    title: '立即傳送？',
    ...
    toolView: {
        ...
        input: '輸入',
        output: '輸出',
        payloadTruncated: '為了效能，已截斷大型負載。',
        showFullPayload: '顯示完整負載',
        showLessPayload: '顯示較少',
    },
    ...
    executionRuns: {
        ...
        approvalHelpBody: '「先詢問」會在此操作從該介面執行前建立核准請求。對於 AI 工作階段，該請求會排入現有核准介面，而不會在強制回應視窗中等待。「允許」則讓此操作從該介面執行，而不需要核准請求。',
        toolExposure: {
            title: '工具公開',
...
settingsSession: {
    newSessionDraftEntry: {
        ...
        messageSending: {
            ...
            pendingDeliveryTimingFooter: '選擇待處理訊息是在主要回覆就緒後送出，或等所有已追蹤的執行階段活動閒置後再送出。',
            pendingDeliveryTiming: {
                afterForegroundReadyTitle: '主要回覆之後',
                afterForegroundReadySubtitle: '代理可以接受下一回合時立即送出待處理訊息。',
                afterRuntimeIdleTitle: '執行階段閒置後',
                afterRuntimeIdleSubtitle: '當已追蹤的執行階段活動仍在進行時，繼續保留待處理訊息。',
            },
