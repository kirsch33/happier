...
export const ru: TranslationStructure = {
  ...
  connectedServices: {
    ...
    authSwitch: {
      ...
      switchFailed: "Не удалось сменить авторизацию для этой сессии.",
            errors: {
                groupGenerationConflict: 'Пул аккаунтов изменился до завершения переключения. Обновите список аккаунтов и попробуйте снова.',
                ...
                groupMissing: 'Выбранный пул аккаунтов больше недоступен. Обновите список аккаунтов и выберите другой пул.',
    ...
    defaultAuth: {
      ...
      warning: {
        ...
        connected_group_unavailable:
          "Подключенный пул по умолчанию недоступен; используется нативная аутентификация.",
    ...
    list: {
      ...
      addServiceTitle: "Подключить сервис",
      addServiceMessage: "Выберите сервис, чтобы подключить аккаунт.",
    },
    ...
    account: {
      ...
      capacity: ({ percent }: { percent: number }) => `${percent}% ёмкости`,
      memberEnabledLabel: "Включено в пуле",
      poolsLabel: "Пулы",
      planEmailSubtitle: ({ plan, email }: { plan: string; email: string }) => `${plan} · ${email}`,
      poolsCount: ({ count }: { count: number }) => count === 1 ? "1 пул" : `${count} пулов`,
      defaultStarA11y: "Аккаунт по умолчанию",
      setActiveA11y: "Сделать активным аккаунтом",
      activeMemberA11y: "Активный аккаунт",
      resets: {
        use: "Применить",
        available: "Сброс доступен",
        rowLabel: ({ date, countdown }: { date: string; countdown: string }) => `Истекает ${date} · ${countdown}`,
        now: "сейчас",
        inDays: ({ days }: { days: number }) => `через ${days}д`,
        confirmTitle: "Применить этот сброс?",
        confirmMessage: "Это применит сброс использования, чтобы сейчас восстановить квоту. Отменить нельзя.",
    ...
    detail: {
      ...
      errors: {
        credentialReferencedByGroup: "Эта учетная запись все еще используется пулом аккаунтов. Удалите ее из пула и повторите попытку.",
        ...
        groupRequestFailed: "Запрос пула аккаунтов не удался. Обновите подключенные сервисы и повторите попытку.",
        generationConflict: "Этот пул аккаунтов изменился до завершения действия. Обновите подключенные сервисы и повторите попытку.",
        groupNotFound: "Этот пул аккаунтов больше не существует. Обновите подключенные сервисы и повторите попытку.",
        memberNotFound: "Эта учетная запись больше не является участником пула. Обновите подключенные сервисы и повторите попытку.",
        profileNotFound: "Эта подключенная учетная запись больше не существует. Обновите подключенные сервисы и повторите попытку.",
        fallbackDisabled: "Ручное переключение пула отключено этим сервером.",
        ...
        disconnectGroupCleanupRetryTitle: "Удалить из пулов?",
        disconnectGroupCleanupRetryBody: ({ service, profileId }: { service: string; profileId: string }) =>
          `${service} (${profileId}) все еще используется пулом аккаунтов. Удалить из пулов и отключить?`,
      ...
      groupActions: {
        title: "Действия пула",
        createTitle: "Создать пул",
        createSubtitle: "Добавить резервный пул для этого подключенного сервиса.",
        groupIdTitle: "ID пула",
        groupIdBody: "Выберите короткий ID для этого пула подключенного сервиса.",
        groupIdPlaceholder: "pul-komandy",
        invalidGroupIdTitle: "Недопустимый ID пула",
        invalidGroupIdBody: "Используйте буквы, цифры, точку, дефис или подчеркивание (макс. 64).",
        displayNameTitle: "Отображаемое имя пула",
        ...
        deleteTitle: "Удалить пул",
        deleteConfirmTitle: "Удалить пул",
        deleteConfirmBody: ({ group }: { group: string }) => `Удалить "${group}"? Сеансам, использующим этот пул, понадобится другой выбор аккаунта.`,
        ...
        addMemberSubtitle: "Добавьте существующий подключенный профиль в этот пул.",
        noProfilesAvailable: "Все подключенные профили уже являются участниками.",
        memberProfileTitle: "Профиль участника",
        memberProfileBody: "Введите ID профиля, который нужно добавить в этот пул.",
      ...
      groupDetail: {
        ...
        recoveryModeOffSubtitle: "Не восстанавливать этот пул автоматически.",
        ...
        recoveryPromptSubtitle: "Использовать стандартные подсказки восстановления и возобновления для этого пула.",
        missingTitle: "Пул не найден",
        missingBody: ({ service, groupId }: { service: string; groupId: string }) =>
          `Пул "${groupId}" не существует для ${service}.`,
      },
    },
    pools: {
      title: "Пулы",
      ...
      manualBadge: "Вручную",
      capacity: ({ percent }: { percent: number }) => `${percent}% ёмкости`,
      avatarOverflowA11y: ({ count }: { count: number }) => `ещё ${count} участников`,
      memberWarningsA11y: ({ count }: { count: number }) => `${count} участников требуют внимания`,
      create: {
        title: "Создать пул",
        subtitle: "Добавить резервный пул для этого подключенного сервиса.",
      },
      empty: {
      ...
      behavior: {
        ...
        autoRestorePrimarySubtitle: "Возвращаться к основному участнику, когда его квота сбрасывается.",
        switchOnGroupSubtitle: "Переключаться на другого участника, когда это происходит.",
        switchOn: {
          usageLimit: "Достигнут лимит использования",
          authExpired: "Срок авторизации истёк",
          accountChanged: "Аккаунт изменён",
          refreshFailure: "Не удалось обновить",
        },
      },
      delete: {
        title: "Удалить пул",
        subtitle: "Удалить этот пул. Аккаунты участников останутся подключенными.",
        confirmTitle: "Удалить пул",
        confirmMessage: ({ name }: { name: string }) => `Удалить "${name}"? Сеансам, использующим этот пул, понадобится другой выбор аккаунта.`,
      },
    },
    profile: {
    ...
    authModal: {
      ...
      groupNeedsMembersSubtitle: "Добавьте или включите участника перед использованием пула",
      groupSwitchingSubtitle: "Переключение участника пула",
      groupErrorSubtitle: "Этот пул требует внимания",
  ...
  directSessions: {
    ...
    keepInAttention: "Оставить в «Требует внимания»",
    keepInAttentionSubtitle: "Останется здесь даже после прочтения",
    removeFromAttention: "Убрать из «Требует внимания»",
    removeFromAttentionSubtitle: "После прочтения снова опустится ниже в списке",
  ...
  status: {
    ...
    keptInAttention: "оставлено в разделе внимания",
  ...
  session: {
    ...
    usageLimitRecovery: {
      ...
      resetCreditBody: ({ count }: { count: number }) =>
        `${count} ${count === 1 ? "сброс использования доступен" : "сброса использования доступны"}.`,
      resetCreditExpiresBody: ({ count, time }: { count: number; time: string }) =>
        `${count} ${count === 1 ? "сброс использования доступен" : "сброса использования доступны"}; следующий истекает ${time}.`,
      ...
      consumeResetCreditAction: "Применить сброс",
      ...
      hideBannerAction: "Скрыть баннер лимита использования",
      showBannerAction: "Показать баннер лимита использования",
    ...
    agentContinuation: {
      ...
      detailDescriptionEmpty: 'Разговора, который можно сохранить, пока нет. Ничего не отправится до вашего следующего сообщения.',
      ...
      handedOver: {
          open: "Показать переданный здесь контекст",
          title: "Переданный контекст",
          reconstructed: "Восстановлено сейчас из транскрипта этой сессии, а не сохранено тогда, — поэтому может отличаться от отправленного. То, что отслеживал предыдущий агент, и его собственный журнал восстановить нельзя, поэтому они не показаны.",
      ...
      unavailable: {
        unsupportedSession: ({ agent }: { agent: string }) => `Эту сессию нельзя продолжить с ${agent}.`,
        updateCli: "Обновите CLI на этой машине, чтобы сменить агента.",
        updateOrReconnect: "Обновите или переподключите CLI, чтобы сменить агента.",
        targetNotProven: ({ agent }: { agent: string }) => `Переключение на ${agent} пока не поддерживается.`,
        targetUnavailable: ({ agent }: { agent: string }) => `${agent} недоступен на этой машине.`,
      },
      transition: {
        rejected: {
          unsupportedOperation: 'Эта сессия не поддерживает смену агента. Ничего не отправлено.',
          forbidden: 'У вас нет прав менять агента этой сессии. Ничего не отправлено.',
          sameTarget: ({ agent }: { agent: string }) => `Эта сессия уже работает с ${agent}. Ничего не отправлено.`,
          staleSelection: 'Сессия изменилась, пока вы выбирали. Ничего не отправлено — попробуйте ещё раз.',
          targetUnavailable: ({ agent }: { agent: string }) => `${agent} недоступен на этой машине. Ничего не отправлено.`,
          sourceNotIdle: ({ agent }: { agent: string }) => `${agent} ещё работает. Ничего не отправлено — попробуйте, когда он закончит.`,
          sourceStopFailed: ({ agent }: { agent: string }) => `Не удалось остановить ${agent}, поэтому ничего не изменилось. Ничего не отправлено.`,
        },
    ...
    sourceContext: {
        chipLabel: ({ session }: { session: string }) => `Из ${session}`,
        unknownSession: "другой сессии",
        detailTitle: "Продолжение другой сессии",
        detailBodyLatest: ({ session }: { session: string }) => `Разговор из ${session} будет перенесён как контекст этой новой сессии.`,
        detailBodyAtMessage: ({ session }: { session: string }) => `Разговор из ${session}, до выбранного сообщения, будет перенесён как контекст этой новой сессии.`,
        carriedOver: "Разговор будет перенесён",
        removeAction: "Убрать",
    ...
    forking: {
      ...
      strategy: {
          title: "Создать ветку сессии",
          subtitleLatest: "Ответвиться от текущего состояния этого разговора.",
          subtitleFromMessage: "Ответвиться от этого места в разговоре.",
          recommended: "Рекомендуется",
          native: {
              title: "Нативная ветка",
              subtitle: "Агент ветвит собственный разговор. Ближе всего к оригиналу.",
          },
          replay: {
          ...
          configure: {
              ...
              subtitle: "Выберите другого агента, модель, машину или папку и перенесите этот разговор.",
          },
          unavailable: {
              nativeAgent: "Этот агент не может ответвить собственный разговор.",
              nativeFromMessage: "Этот агент может ответвить весь разговор, но не от более раннего сообщения.",
              replayOff: "Replay отключён в Настройках.",
              replaySettingsAction: "Настройки Replay",
          },
          progress: {
              creatingNative: "Создание нативной ветки…",
              creatingReplay: "Создание ветки Replay…",
              opening: "Открытие ветки…",
              stalledTitle: "Ветка создана",
              stalledBody: "Она ещё не появилась здесь. Попробуйте открыть её снова.",
          ...
          unknown: {
              ...
              noneFound: "Подходящей ветки пока нет. Возможно, она ещё запускается — можно проверить снова.",
              ambiguous: "Найдено несколько подходящих веток. Откройте список сессий и выберите нужную.",
          },
          failure: {
  ...
  modelPickerOverlay: {
    ...
    auggieIndexingChip: {
      ...
      model: {
        ...
        applyTimingNextMessage: "Применится со следующего сообщения",
        applyTimingNewSession: "Применится при запуске новой сессии",
    ...
    newSessionDraftEntry: {
	    ...
	    sessionList: {
         ...
         agentActivityCountDisabledSubtitle: 'Не показывать счётчики агентов в строках',
	        ...
	        attentionStandingDefaultUnavailableSubtitle: 'Сначала выберите размещение в «Сессии, требующие внимания»',
