...
export const en = {
    ...
    connectedServices: {
        ...
        authSwitch: {
            ...
            errors: {
                groupGenerationConflict: 'The account pool changed before the switch completed. Refresh the account list and try again.',
                ...
                groupMissing: 'The selected account pool is no longer available. Refresh the account list and choose another pool.',
        ...
        diagnostics: {
            ...
            status: {
                providerSessionStateUnavailableForResume: 'Session state could not be carried over',
                providerAccountAdoptionMismatch: 'Provider stayed on a different account',
                postSwitchVerificationFailed: 'Provider account could not be verified',
                recoveryRetryScheduled: 'Provider recovery retry scheduled',
                metadataUpdateFailed: 'Session auth selection could not be saved',
                noEligibleGroupMember: 'No fallback account is eligible',
        ...
        list: {
            ...
            addServiceTitle: 'Connect a service',
            addServiceMessage: 'Choose a service to connect an account.',
        },
        ...
        account: {
            ...
            defaultStarA11y: 'Default account',
            setActiveA11y: 'Set as active account',
            activeMemberA11y: 'Active account',
            resets: {
                use: 'Use',
                available: 'Reset available',
                rowLabel: ({ date, countdown }: { date: string; countdown: string }) => `Expires ${date} · ${countdown}`,
                now: 'now',
                inDays: ({ days }: { days: number }) => `in ${days}d`,
                confirmTitle: 'Use this reset?',
                confirmMessage: 'This applies a usage reset to recover quota now. It cannot be undone.',
                confirmCta: 'Use reset',
            },
        },
        oauthPaste: {
        ...
        detail: {
            ...
            errors: {
                credentialReferencedByGroup: 'This account is still used by an account pool. Remove it from the pool, then try again.',
                credentialNotFound: 'This connected account was already removed.',
                credentialRequestFailed: 'The connected account request failed. Refresh connected services and try again.',
                groupRequestFailed: 'The account pool request failed. Refresh connected services and try again.',
                generationConflict: 'This account pool changed before the action completed. Refresh connected services and try again.',
                groupNotFound: 'This account pool no longer exists. Refresh connected services and try again.',
                memberNotFound: 'This account is no longer a member of the pool. Refresh connected services and try again.',
                profileNotFound: 'This connected account no longer exists. Refresh connected services and try again.',
                fallbackDisabled: 'Manual pool switching is disabled by this server.',
                requestFailed: 'The connected-service request failed. Refresh connected services and try again.',
                runtimeCooldown: ({ reset }: { reset: string }) =>
                    `This account is cooling down until ${reset}.`,
                runtimeCooldownWithoutReset: 'This account is temporarily cooling down.',
                runtimeCooldownOverrideTitle: 'Switch to cooling-down account?',
                runtimeCooldownOverrideBody: ({ reset }: { reset: string }) =>
                    `This account is cooling down until ${reset}. Switch to it anyway?`,
                runtimeCooldownOverrideBodyWithoutReset: 'This account is temporarily cooling down. Switch to it anyway?',
                runtimeCooldownOverrideConfirm: 'Switch anyway',
                disconnectGroupCleanupRetryTitle: 'Remove from pools?',
                disconnectGroupCleanupRetryBody: ({ service, profileId }: { service: string; profileId: string }) =>
                    `${service} (${profileId}) is still used by an account pool. Remove it from pools and disconnect it?`,
                disconnectGroupCleanupRetryConfirm: 'Remove and disconnect',
            },
            profiles: {
            ...
            groups: {
                title: 'Pools',
                empty: 'No pools yet.',
                activeMember: ({ member }: { member: string }) => `Active ${member}`,
            ...
            groupActions: {
                ...
                createSubtitle: 'Add a fallback pool for this connected service.',
                groupIdTitle: 'Pool id',
                groupIdBody: 'Choose a short id for this connected-service pool.',
                groupIdPlaceholder: 'team-pool',
                invalidGroupIdTitle: 'Invalid pool id',
                invalidGroupIdBody: 'Use letters, numbers, dot, hyphen, or underscore (max 64).',
                displayNameTitle: 'Pool display name',
                ...
                deleteConfirmTitle: 'Delete pool',
                deleteConfirmBody: ({ group }: { group: string }) => `Delete "${group}"? Sessions using this pool will need another account selection.`,
                ...
                runtimeFallbackUnsupported: 'This service cannot be used for runtime account fallback.',
                useManualStrategy: 'Use manual switching',
                usePriorityStrategy: 'Use priority order',
                addMember: 'Add member',
                addMemberSubtitle: 'Add an existing connected profile to this pool.',
                noProfilesAvailable: 'All connected profiles are already members.',
                memberProfileTitle: 'Member profile',
                memberProfileBody: 'Enter the profile id to add to this pool.',
            ...
            groupDetail: {
                ...
                recoveryModeOffSubtitle: 'Do not recover this pool automatically.',
                ...
                recoveryPromptSubtitle: 'Use the standard recovery and resume prompts for this pool.',
                missingTitle: 'Pool not found',
                missingBody: ({ service, groupId }: { service: string; groupId: string }) =>
                    `No pool named "${groupId}" exists for ${service}.`,
            },
        },
        pools: {
            title: 'Pools',
            ...
            manualBadge: 'Manual',
            capacity: ({ percent }: { percent: number }) => `${percent}% capacity`,
            avatarOverflowA11y: ({ count }: { count: number }) => `${count} more members`,
            memberWarningsA11y: ({ count }: { count: number }) => `${count} members need attention`,
            create: {
                title: 'Create pool',
                subtitle: 'Add a fallback pool for this connected service.',
            },
            empty: {
                title: 'No pools yet',
            ...
            behavior: {
                ...
                autoRestorePrimarySubtitle: 'Switch back to the top member once its quota resets.',
                switchOnGroupSubtitle: 'Switch to another member when this happens.',
                switchOn: {
            ...
            delete: {
                title: 'Delete pool',
                subtitle: 'Remove this pool. Member accounts stay connected.',
                confirmTitle: 'Delete pool',
                confirmMessage: ({ name }: { name: string }) => `Delete "${name}"? Sessions using this pool will need another account selection.`,
            },
        },
        profile: {
        ...
        authModal: {
            ...
            groupNeedsMembersSubtitle: 'Add or enable a member before using this pool',
            groupSwitchingSubtitle: 'Switching pool member',
            groupErrorSubtitle: 'This pool needs attention',
            ...
            claude: {
                ...
                sections: {
                    ...
                    claudeRemoteSdk: {
                        ...
                        footer: "Use the Agent SDK path when unified terminal runtime is off or unavailable."
                    }
                },
                fields: {
                    ...
                    claudeUnifiedTerminalHost: {
                        ...
                        options: {
                            auto: {
                                title: "Auto",
                                subtitle: "Use tmux when available, otherwise use bundled zellij."
                            },
                            tmux: {
                                title: "tmux",
                                subtitle: "Use the system tmux installation."
                            },
                            zellij: {
                                title: "zellij",
    ...
    session: {
        ...
        usageLimitRecovery: {
            ...
            resetCreditBody: ({ count }: { count: number }) => `${count} usage ${count === 1 ? 'reset is' : 'resets are'} available.`,
            resetCreditExpiresBody: ({ count, time }: { count: number; time: string }) => `${count} usage ${count === 1 ? 'reset is' : 'resets are'} available; next expires ${time}.`,
            ...
            consumeResetCreditAction: 'Apply reset',
            ...
            hideBannerAction: 'Hide usage limit banner',
            showBannerAction: 'Show usage limit banner',
        ...
        freshSubtitle: 'Open a new draft whenever you choose New session.',
          ...
          messageSending: {
              ...
              nonSteerablePrompt: {
                ...
                queueSilentlyTitle: 'Queue silently',
                queueSilentlySubtitle: 'Put the message into Pending without asking.',
                offTitle: 'Off (legacy)',
          ...
          usageLimitRecovery: {
              ...
              resumePromptCustomSelectedSubtitle: 'Send a custom continuation prompt after recovery.',
