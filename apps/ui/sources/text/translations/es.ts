...
export const es: TranslationStructure = {
    settingsKeyboard: {
        ...
        commands: {
            ...
            sessionsSelectionToggleFocused: 'Seleccionar la sesión enfocada',
            ...
            sessionsSelectionClear: 'Borrar la selección de sesiones',
  ...
  status: {
    ...
    backgroundActive: ({ count }: { count: number }) => `${count} en ejecución en segundo plano`,
  ...
  connectedServices: {
    ...
    authSwitch: {
      ...
      switchFailed: "No se pudo cambiar la autenticación de esta sesión.",
            errors: {
                groupGenerationConflict: 'El Pool de cuentas cambió antes de que se completara el cambio. Actualiza la lista de cuentas e inténtalo de nuevo.',
                ...
                groupMissing: 'El Pool de cuentas seleccionado ya no está disponible. Actualiza la lista de cuentas y elige otro Pool.',
    ...
    diagnostics: {
      title: {
        ...
        runtime_auth_recovery_superseded: "La recuperación del proveedor fue reemplazada",
        runtime_auth_generation_stale: "La recuperación del proveedor está obsoleta",
        hot_apply_unavailable: "El cambio de cuenta en caliente no está disponible",
        app_server_unavailable: "El servidor de la app del proveedor no está disponible",
        provider_account_adoption_mismatch: "El proveedor no cambió de cuenta",
        provider_account_identity_unverified: "La identidad de la cuenta del proveedor no está verificada",
        post_switch_verification_failed: "No se pudo verificar la cuenta del proveedor",
        quota_snapshot_stale: "Los datos de cuota están obsoletos",
      ...
      status: {
        ...
        runtime_auth_recovery_superseded: "La recuperación del proveedor fue reemplazada",
        runtime_auth_generation_stale: "La generación de recuperación del proveedor está obsoleta",
        hot_apply_unavailable: "Cambio de cuenta en caliente no disponible",
        app_server_unavailable: "Servidor de la app del proveedor no disponible",
        provider_account_adoption_mismatch: "El proveedor permaneció en otra cuenta",
        provider_account_identity_unverified: "Identidad de la cuenta del proveedor no verificada",
        post_switch_verification_failed: "No se pudo verificar la cuenta del proveedor",
        quota_snapshot_stale: "Los datos de cuota están obsoletos",
    ...
    defaultAuth: {
      ...
      warning: {
        ...
        connected_group_unavailable:
          "El Pool conectado predeterminado no está disponible; se usa la autenticación nativa.",
    ...
    list: {
      ...
      addServiceTitle: "Conectar un servicio",
      addServiceMessage: "Elige un servicio para conectar una cuenta.",
    },
    ...
    quota: {
      ...
      recoveryCreditSubtitle: "Aplica un restablecimiento de uso para recuperar cuota ahora.",
    ...
    account: {
      ...
      memberEnabledLabel: "Habilitado en el Pool",
      poolsLabel: "Pools",
      planEmailSubtitle: ({ plan, email }: { plan: string; email: string }) => `${plan} · ${email}`,
      poolsCount: ({ count }: { count: number }) => count === 1 ? "1 pool" : `${count} pools`,
      defaultStarA11y: "Cuenta predeterminada",
      setActiveA11y: "Establecer como cuenta activa",
      activeMemberA11y: "Cuenta activa",
      resets: {
        use: "Usar",
        available: "Reinicio disponible",
        rowLabel: ({ date, countdown }: { date: string; countdown: string }) => `Caduca ${date} · ${countdown}`,
        now: "ahora",
        inDays: ({ days }: { days: number }) => `en ${days}d`,
        confirmTitle: "¿Usar este reinicio?",
        confirmMessage: "Esto aplica un reinicio de uso para recuperar cuota ahora. No se puede deshacer.",
        confirmCta: "Usar reinicio",
      },
    },
    oauthPaste: {
    ...
    detail: {
      ...
      errors: {
        credentialReferencedByGroup: "Esta cuenta todavía se usa en un Pool de cuentas. Quítala del Pool y vuelve a intentarlo.",
        credentialNotFound: "Esta cuenta conectada ya se eliminó.",
        credentialRequestFailed: "La solicitud de la cuenta conectada falló. Actualiza los servicios conectados y vuelve a intentarlo.",
        groupRequestFailed: "La solicitud del Pool de cuentas falló. Actualiza los servicios conectados y vuelve a intentarlo.",
        generationConflict: "Este Pool de cuentas cambió antes de que terminara la acción. Actualiza los servicios conectados y vuelve a intentarlo.",
        groupNotFound: "Este Pool de cuentas ya no existe. Actualiza los servicios conectados y vuelve a intentarlo.",
        memberNotFound: "Esta cuenta ya no es miembro del Pool. Actualiza los servicios conectados y vuelve a intentarlo.",
        profileNotFound: "Esta cuenta conectada ya no existe. Actualiza los servicios conectados y vuelve a intentarlo.",
        fallbackDisabled: "Este servidor desactivó el cambio manual de Pool.",
        requestFailed: "La solicitud del servicio conectado falló. Actualiza los servicios conectados y vuelve a intentarlo.",
        runtimeCooldown: ({ reset }: { reset: string }) =>
          `Esta cuenta está en espera hasta ${reset}.`,
        runtimeCooldownWithoutReset: "Esta cuenta está temporalmente en espera.",
        runtimeCooldownOverrideTitle: "¿Cambiar a una cuenta en espera?",
        runtimeCooldownOverrideBody: ({ reset }: { reset: string }) =>
          `Esta cuenta está en espera hasta ${reset}. ¿Cambiar a ella de todos modos?`,
        runtimeCooldownOverrideBodyWithoutReset: "Esta cuenta está temporalmente en espera. ¿Cambiar a ella de todos modos?",
        runtimeCooldownOverrideConfirm: "Cambiar de todos modos",
        disconnectGroupCleanupRetryTitle: "¿Quitar de los Pools?",
        disconnectGroupCleanupRetryBody: ({ service, profileId }: { service: string; profileId: string }) =>
          `${service} (${profileId}) todavía se usa en un Pool de cuentas. ¿Quitarla de los Pools y desconectarla?`,
        disconnectGroupCleanupRetryConfirm: "Quitar y desconectar",
      },
      profiles: {
      ...
      groupActions: {
        title: "Acciones del Pool",
        createTitle: "Crear Pool",
        createSubtitle: "Agrega un Pool de respaldo para este servicio conectado.",
        groupIdTitle: "ID del Pool",
        groupIdBody: "Elige un ID corto para este Pool de servicio conectado.",
        groupIdPlaceholder: "pool-equipo",
        invalidGroupIdTitle: "ID de Pool no válido",
        invalidGroupIdBody: "Usa letras, números, punto, guion o guion bajo (máx. 64).",
        displayNameTitle: "Nombre visible del Pool",
        ...
        deleteConfirmTitle: "Eliminar Pool",
        deleteConfirmBody: ({ group }: { group: string }) => `¿Eliminar "${group}"? Las sesiones que usen este Pool necesitarán otra selección de cuenta.`,
        ...
        runtimeFallbackUnsupported: "Este servicio no se puede usar como cuenta de respaldo en tiempo de ejecución.",
        useManualStrategy: "Usar cambio manual",
        usePriorityStrategy: "Usar orden de prioridad",
        addMember: "Agregar miembro",
        addMemberSubtitle: "Agrega un perfil conectado existente a este Pool.",
        noProfilesAvailable: "Todos los perfiles conectados ya son miembros.",
        memberProfileTitle: "Perfil del miembro",
        memberProfileBody: "Ingresa el ID del perfil que quieres agregar a este Pool.",
        ...
        removeMemberConfirmBody: ({ profileId }: { profileId: string }) => `¿Quitar "${profileId}" de este Pool?`,
        ...
        membersSubtitle: "Marca los perfiles que quieres incluir en este Pool.",
      },
      groupDetail: {
        routeTitle: "Pool",
        nameTitle: "Nombre del Pool",
        ...
        recoveryModeOffSubtitle: "No recuperar este Pool automáticamente.",
        ...
        recoveryPromptSubtitle: "Usa los mensajes estándar de recuperación y reanudación para este Pool.",
        missingTitle: "Pool no encontrado",
        missingBody: ({ service, groupId }: { service: string; groupId: string }) =>
          `No existe ningún Pool llamado "${groupId}" para ${service}.`,
      },
    },
    pools: {
      title: "Pools",
      ...
      manualBadge: "A mano",
      capacity: ({ percent }: { percent: number }) => `${percent}% de capacidad`,
      avatarOverflowA11y: ({ count }: { count: number }) => `${count} miembros más`,
      memberWarningsA11y: ({ count }: { count: number }) => `${count} miembros necesitan atención`,
      create: {
        title: "Crear Pool",
        subtitle: "Agrega un Pool de respaldo para este servicio conectado.",
      },
      empty: {
      ...
      detail: {
        ...
        noMembersSubtitle: "Agrega una cuenta conectada a este Pool.",
      ...
      behavior: {
        ...
        autoRestorePrimarySubtitle: "Vuelve al miembro principal cuando su cuota se reinicie.",
        switchOnGroupSubtitle: "Cambia a otro miembro cuando ocurra esto.",
        switchOn: {
          usageLimit: "Límite de uso alcanzado",
          authExpired: "Autenticación caducada",
          accountChanged: "Cuenta cambiada",
          refreshFailure: "Error al actualizar",
        },
      },
      delete: {
        title: "Eliminar Pool",
        subtitle: "Elimina este Pool. Las cuentas miembro siguen conectadas.",
        confirmTitle: "Eliminar Pool",
        confirmMessage: ({ name }: { name: string }) => `¿Eliminar "${name}"? Las sesiones que usen este Pool necesitarán otra selección de cuenta.`,
      },
    },
    profile: {
    ...
    authModal: {
      ...
      groupNeedsMembersSubtitle: "Agrega o habilita un miembro antes de usar este Pool",
      groupSwitchingSubtitle: "Cambiando miembro del Pool",
      groupErrorSubtitle: "Este Pool necesita atención",
  ...
  session: {
    ...
    usageLimitRecovery: {
      ...
      resetCreditBody: ({ count }: { count: number }) =>
        `${count} ${count === 1 ? "restablecimiento de uso disponible" : "restablecimientos de uso disponibles"}.`,
      resetCreditExpiresBody: ({ count, time }: { count: number; time: string }) =>
        `${count} ${count === 1 ? "restablecimiento de uso disponible" : "restablecimientos de uso disponibles"}; el próximo vence ${time}.`,
      ...
      consumeResetCreditAction: "Aplicar restablecimiento",
      ...
      hideBannerAction: "Ocultar banner de límite de uso",
      showBannerAction: "Mostrar banner de límite de uso",
    ...
    activity: {
        sectionTitle: "En ejecución ahora",
        openFullRoster: "Abrir todos los agentes",
    },
    workflow: {
    ...
    forking: {
      ...
      strategy: {
        ...
        pendingActivation: {
            ...
            waiting: { title: 'Esperando para reanudar', body: 'Tu mensaje está seguro en la cola mientras el daemon reanuda esta sesión.' },
            failed: { title: 'No se pudo reanudar la sesión', body: 'Tu mensaje sigue seguro en la cola. Vuelve a intentarlo cuando quieras.' },
	    ...
	    staleRunner: {
	      ...
	      showBannerAction: "Mostrar aviso de CLI anterior",
	      hideBannerAction: "Ocultar aviso de CLI anterior",
    ...
    machineOfflineNoticeBody: ({ machine }: { machine: string }) =>
      ...
      machineOfflineCannotResume:
        "La máquina está sin conexión. Vuelve a conectarla para reanudar esta sesión.",
          ...
          openTranscriptNavigation: "Abrir navegación de la transcripción",
          participants: {
            to: 'A',
            lead: 'Principal',
          ...
          agentActivity: {
              composer: {
                  workflowsWithAgents: ({ workflows, agents }: { workflows: number; agents: number }) =>
                    `${workflows} ${workflows === 1 ? 'flujo de trabajo' : 'flujos de trabajo'}, ${agents} ${agents === 1 ? 'agente' : 'agentes'}`,
                  workflowsRunning: ({ count }: { count: number }) => (count === 1 ? '1 flujo de trabajo en curso' : `${count} flujos de trabajo en curso`),
                  subagentsWorking: ({ count }: { count: number }) => (count === 1 ? '1 subagente trabajando' : `${count} subagentes trabajando`),
            ...
            row: {
              a11yLabel: ({ title, status }: { title: string; status: string }) => `${title}, ${status}`,
                expand: ({ title }: { title: string }) => `Mostrar la actividad reciente de ${title}`,
                collapse: ({ title }: { title: string }) => `Ocultar la actividad reciente de ${title}`,
            },
            staleness: {
              quiet: "Sin actualizaciones recientes",
              stale: ({ minutes }: { minutes: number }) => `Sin actualizaciones desde hace más de ${minutes} min`,
            },
            sessionNotice: {
              stopped: "Esta sesión se detuvo: puede que lo que se muestra ya no esté en ejecución.",
              stoppedAuth: "Esta sesión se detuvo porque caducó el inicio de sesión: puede que lo que se muestra ya no esté en ejecución.",
              unobserved: "Esta sesión ya no se está observando: puede que lo que se muestra ya no esté en ejecución.",
            },
            backgroundTask: {
                title: "Comando en segundo plano",
                statusWithDuration: ({ status, duration }: { status: string; duration: string }) => `${status} · ${duration}`,
                openCommand: "Abrir el comando en la transcripción",
            },
            preview: {
    ...
    reviewFindings: {
      ...
      errors: {
        ...
        errors: {
          ...
          discardFailed: "No se pudo descartar el mensaje pendiente",
  ...
  sessionsList: {
    ...
    moveToWorkspaceRoot: 'Raíz del espacio de trabajo',
        ...
        selectionSetTags: 'Definir etiquetas',
        ...
        selectionSetTagsPromptTitle: 'Definir etiquetas',
        ...
        selectionCancelRunningA11yLabel: 'Cancelar la acción sobre las sesiones seleccionadas',
        ...
        selectionDismissResultA11yLabel: 'Descartar el resultado de la acción sobre las sesiones seleccionadas',
  ...
  toolView: {
    ...
    bashView: {
        backgroundNotice: "Enviado a segundo plano: este paso no espera a que termine.",
  ...
  executionRuns: {
    ...
    details: {
      ...
      timestamps: {
        ...
        approvalHelpBody: '“Preguntar primero” crea una solicitud de aprobación antes de que esta acción se ejecute desde esa superficie. Para las sesiones de IA, esa solicitud queda en la superficie de aprobaciones existente y no espera en un modal. “Permitido” deja que la acción se ejecute desde esa superficie sin una solicitud de aprobación.',
        toolExposure: {
...
settingsSession: {
    newSessionDraftEntry: {
        ...
        freshSubtitle: 'Abre un borrador nuevo cada vez que elijas Nueva sesión.',
	      ...
	      sessionList: {
           ...
           agentActivityCountTitle: 'Recuento de agentes en las filas',
           agentActivityCountEnabledSubtitle: 'Muestra cuántos agentes trabajan en cada sesión',
           agentActivityCountDisabledSubtitle: 'Mantén las filas sin recuentos de agentes',
          ...
          rootGroups: {
              ...
              mobileLayout: {
                  ...
                  footer: 'Elige el diseño de teléfono que se usa dentro de las sesiones. En modo cockpit, deslizar a izquierda o derecha sobre la barra inferior pasa a la sesión siguiente o anterior, en el orden de la lista que viste por última vez.',
              },
      ...
      messageSending: {
        ...
        pendingDeliveryTimingTitle: "Momento de la cola pendiente",
        pendingDeliveryTimingFooter:
          "Elige si los mensajes pendientes se envían cuando la respuesta principal está lista o esperan a que se detenga toda la actividad de runtime seguida.",
        pendingDeliveryTiming: {
          afterForegroundReadyTitle: "Después de la respuesta principal",
          afterForegroundReadySubtitle:
            "Envía mensajes pendientes en cuanto el agente pueda aceptar el siguiente turno.",
          afterRuntimeIdleTitle: "Cuando el runtime esté inactivo",
          afterRuntimeIdleSubtitle:
            "Mantén los mensajes pendientes esperando mientras siga activa la actividad de runtime seguida.",
        },
        ...
        nonSteerablePrompt: {
          ...
          queueSilentlyTitle: 'Poner en cola en silencio',
          queueSilentlySubtitle: 'Colocar el mensaje en Pendientes sin preguntar.',
      ...
      usageLimitRecovery: {
        ...
        resumePromptCustomSubtitle:
          "Tras la recuperación, enviar tu propio prompt de continuación.",
        resumePromptCustomSelectedSubtitle:
          "Enviar un prompt de continuación personalizado tras la recuperación.",
  ...
  message: {
    ...
    runtimeConfigOutcomeAlreadySet: "Ya está configurado",
