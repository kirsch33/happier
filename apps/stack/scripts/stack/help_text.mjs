const STACK_HELP_USAGE_LINES = [
  ...
  'hstack stack install <name> [--repo=default|dev|<path>] [--port=NNN] [--desktop=install|build|none] [--no-desktop] [--service=user|system|none] [--force-rebuild] [--dry-run] [--json]',
  ...
  'hstack stack fleet-supervisor <name> register|recover|watch|status [-- ...]',
